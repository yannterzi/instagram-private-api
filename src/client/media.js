...
module.exports = class Media extends Resource {
    ...
    getParams() {
        return _.extend(this.params, {
            ...
            carouselMedia: _.map(this.params.carouselMedia, 'params')
        });
    };
    ...
    static configureVideo(session, uploadId, caption, durationms, delay, {
      audio_muted = false,
        trim_type = 0,
        source_type = 'camera',
